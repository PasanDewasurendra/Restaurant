    ...
    public void onClickImageButton(){
        ...
        img_btn_breakfast.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in1=new Intent(mealsbeverages.this,breakfast.class);
                startActivity(in1);
            }
        });
        ...
        img_btn_lunch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in2=new Intent(mealsbeverages.this,lunch.class);
                startActivity(in2);
            }
        });
        ...
        img_btn_dinner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in3=new Intent(mealsbeverages.this,dinnerkisal.class);
                startActivity(in3);
            }
        });
        img_btn_beverages.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in4=new Intent(mealsbeverages.this,beverages.class);
                startActivity(in4);
        ...
        img_btn_desert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             Intent in5=new Intent(mealsbeverages.this,deserts.class);
               startActivity(in5);
            }
        });
